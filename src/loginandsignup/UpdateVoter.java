...
public class UpdateVoter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton11.setBackground(new java.awt.Color(175, 225, 239));
        jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/loginandsignup/1597495-200.png"))); // NOI18N
        ...
        jPanel1.add(jPanel3);
        jPanel3.setBounds(180, 0, 400, 500);
...
UpdateCondidate add=new UpdateCondidate();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!userId.isEmpty()) {
            ...
            boolean updated = updateUserData(userId, fullName, email, password, phoneNumber, city, country, age);

            // Vérifier si la mise à jour a réussi
            if (updated) {
                System.out.println("Données utilisateur mises à jour avec succès !");
            } else {
                System.out.println("Échec de la mise à jour des données utilisateur.");
            }
        } else {
...
private boolean updateUserData(String userId, String fullName, String email, String password, String phoneNumber, String city, String country, String age) {
    try (Connection conn = DatabaseConnection.connect()) {
        if (conn == null) {
            return false;
        }

        String sql = "UPDATE users SET full_name=?, email=?, password=?, phone_number=?, city=?, country=?, Age=? WHERE id=?";
